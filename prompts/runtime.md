# Build a Godot game from a description
...
- Read `godot.md` for engine guidance: stack, project layout, how to run, how to validate, how to capture, and how to drive a game that is already running.

## Delivery

Judge progress from the running game, never from a clean build: verify the structural things yourself (it builds, it imports, no errors, assets present) and let what you see drive the next iteration.
